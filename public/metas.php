...
<?php include __DIR__ . '/../views/partials/toast.php'; ?>
    ...
    <main class="flex-1 overflow-y-auto p-4 lg:p-6 space-y-4">
        <div class="flex items-center justify-between">
            <p class="text-sm text-slate-500 dark:text-slate-400">Acompanhe seus objetivos financeiros.</p>
            <button id="btn-nova-meta" class="flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
                <i data-lucide="plus" class="w-4 h-4"></i> Nova meta
            </button>
        </div>
        <div id="metas-lista" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"></div>
    </main>
</div>

<?php include __DIR__ . '/../views/partials/modal-meta.php'; ?>
